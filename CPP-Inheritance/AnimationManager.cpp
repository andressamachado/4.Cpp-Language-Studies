...
Purpose:			Overloaded function to add a Animation instance to the AnimationManager vector.
...
/**********************************************************************************************
Function name:	operator<<
Purpose:		Overloaded function to output the Animation instances in the AnimationManager vector.
...
ostream& operator<<(ostream& print_output, AnimationManager& animation_manager) {
	...
	for (auto current_animation : animation_manager.animations) {
		...
		print_output << current_animation;
	}
...
Purpose:		Gives the ability to select a specific Animation instance and insert a frame, 
				edit a frame or output a frame.
...
Purpose:		Gives the ability to select a specific Animation instance and delete it.
